...
export const metadata: Metadata = {
  title: 'Contact Us',
  description: `Get in touch with CR Home Pros. Call ${COMPANY.phoneFormatted} for a free estimate. Serving Washington DC, Maryland & Virginia.`,
}
        ...
        <div className="container-custom">
          <div className="grid md:grid-cols-3 gap-6">
            {contactMethods.map((method) => (
                ...
                className="flex items-center gap-4 p-6 bg-dark-50 rounded-2xl hover:bg-primary-50 hover:border-primary-200 border border-transparent transition-all group"
              >
            ...
            <div className="space-y-8">
              ...
              <div className="bg-dark-50 rounded-2xl p-8">
                <div className="flex items-center gap-3 mb-6">
                  ...
                  <h3 className="text-xl font-display font-semibold text-dark-900">
                    Business Hours
                  </h3>
                </div>
                <div className="space-y-3 text-dark-600">
                  <div className="flex justify-between">
                    ...
                    <span className="font-medium text-dark-900">{HOURS.weekday}</span>
                  </div>
                  <div className="flex justify-between">
                    <span>Saturday</span>
                    <span className="font-medium text-dark-900">{HOURS.saturday}</span>
                  </div>
                  <div className="flex justify-between">
                    <span>Sunday</span>
                    <span className="font-medium text-dark-900">{HOURS.sunday}</span>
                  </div>
                  <div className="pt-3 mt-3 border-t border-dark-200">
                    <p className="text-sm text-gold-600 font-medium">🚨 {HOURS.emergency}</p>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-dark-50 rounded-2xl p-8">
                ...
                <p className="text-dark-600 mb-4">
                  We proudly serve the entire DMV area including:
                </p>
                <div className="flex flex-wrap gap-2">
                  {SERVICE_AREAS.slice(0, 8).map((area) => (
                    <span
                      key={area}
                      className="px-3 py-1 bg-white rounded-full text-sm text-dark-600"
                    >
                      {area}
                    </span>
                  ))}
                  <span className="px-3 py-1 bg-primary-100 rounded-full text-sm text-primary-700 font-medium">
                    + more
                  </span>
                </div>
              </div>
              ...
              <div className="bg-dark-50 rounded-2xl p-8">
                ...
                <div className="flex gap-3">
                    ...
                    className="w-12 h-12 rounded-xl bg-white flex items-center justify-center text-dark-500 hover:text-primary-600 hover:bg-primary-50 transition-colors"
                  >
              ...
              <div className="bg-gold-50 border border-gold-200 rounded-2xl p-6 text-center">
                ...
                <p className="text-gold-700 text-sm mt-1">
                  We're happy to assist you in Spanish.
                </p>
              </div>
            </div>
          </div>
